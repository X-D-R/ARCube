...
if __name__ == "__main__":
    ...
    # python main.py detect --model_input "model_script_test.npz" --camera_params "CameraParams/CameraParams.npz" --input_image "old_files/andrew photo video/second pic messy.jpg" --use_flann --draw_match
