...
if __name__ == "__main__":
    ...
    # python script.py register --camera_params CameraParams/CameraParams.npz --input_image old_files/andrew photo video/reference messy.jpg --output_image output_script_test.jpg --crop_method none --feature_method SIFT --model_output model_script_test.npz
    # python script.py detect --model_input model_script_test.npz --input_image old_files/andrew photo video/second pic messy.jpg --use_flann --draw_match
